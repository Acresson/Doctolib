...
ActiveRecord::Schema[7.0].define(version: 2023_05_03_214804) do
  ...
  create_table "medecines", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_medecines_on_doctor_id"
    t.index ["specialty_id"], name: "index_medecines_on_specialty_id"
  end
